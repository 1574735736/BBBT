    ...
    public class OutlineEx : BaseMeshEffect
    {
        ...
        protected override void OnValidate()
        {
            ...
            if (base.graphic.material != null)
            {
                ...
                {
                    var texMaterial = UnityEditor.AssetDatabase.LoadAssetAtPath<Material>("Assets/Materials/OutlineMat.mat");
                    if (texMaterial != null)
                    {
                        base.graphic.material = texMaterial;
                    }
            ...
            Vector2 pUVOriginMin, Vector2 pUVOriginMax)
        {
            ...
            uv += new Vector4(pUVX.x / pTriangleX.magnitude, pUVX.y / pTriangleX.magnitude, 0, 0) * posXOffset * (Vector2.Dot(pTriangleX, Vector2.right) > 0 ? 1 : -1);
            uv += new Vector4(pUVY.x / pTriangleY.magnitude, pUVY.y / pTriangleY.magnitude, 0, 0) * posYOffset * (Vector2.Dot(pTriangleY, Vector2.up) > 0 ? 1 : -1);
            pVertex.uv0 = uv;
