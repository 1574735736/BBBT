...
public class RankView : UIAction
{
    private List<GameObject> p_Togs = new List<GameObject>();
    void Start()
    {
        p_Togs = this.gameObject.GetObjectsWithPrefix("P_Tog");
        SetToggles();
    }
    ...
    void SetToggles()
    {
        o_Selects = this.gameObject.GetObjectsWithPrefix("I_OpenTog");
